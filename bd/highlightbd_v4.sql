...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-02-2021 a las 20:44:39
...
(1, 'Iluminación', 'assets/img/categorias/no-categoria.png'),
(3, 'Herramientas', 'assets/img/categorias/no-categoria.png');
...
(2, 1, 'Fotocontroles', 'assets/img/subcategorias/no-subcategoria.png'),
(4, 1, 'Lamparas LED', 'assets/img/subcategorias/no-subcategoria.png'),
(6, 3, 'Eléctricas', 'assets/img/subcategorias/no-subcategoria.png'),
(7, 3, 'Manuales', 'assets/img/subcategorias/no-subcategoria.png'),
(8, 3, 'Inalámbricas', 'assets/img/subcategorias/no-subcategoria.png'),
(9, 1, 'Lámparas ALTA POTENCIA', 'assets/img/subcategorias/no-subcategoria.png');
...
CREATE TABLE `ventas` (
  ...
  `estadoVENT` enum('nueva','confirmada','entregada','cancelada') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
